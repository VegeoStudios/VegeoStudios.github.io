...
const CONFIG = {
  ...
  resume: {
    fileUrl:
      'https://github.com/VegeoStudios/VegeoStudios.github.io/raw/main/Erik%20Cooper%20-%20Technical%20Resume.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'C#',
    'Python',
